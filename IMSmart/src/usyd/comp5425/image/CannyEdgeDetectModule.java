 ...
 */
/**
 *  I'm stucked at here, this is incompleted, doesn't why it not work
 * 
 *   FUCK!>>>>.
 */
public class CannyEdgeDetectModule  extends FeatureModule {
    ...
    /** Creates a new instance of CannyEdgeDetectModule */
    public CannyEdgeDetectModule() {
        threshold1 = 50;
        threshold2 = 230;
        threshold = 128 ;
        widGaussianKernel = 15;
    }
...
//			throw new IllegalA("The value of the threshold is out of its valid range.");
